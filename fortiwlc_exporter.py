...
class FortiwlcCollector(object):
    def collect(self):
        ...
        for ap_name, ap_data in main(ssidapi,productionapiarray)['ap'].items():
        ...
        '''for campus_name, campus_data in main(ssidapi,productionapiarray)['campus'].items():
            #print(campus_data)
        ...
        for wlc_name, wlc_data in main(ssidapi,productionapiarray)['wlc'].items():
